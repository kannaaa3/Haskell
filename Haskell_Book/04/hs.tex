...
\begin{document}
   ...
   Fractional: Float, Double (twice bit), Rational (carrying 2 int, arbitrarily precise but not efficient as Scientific),  Scientific (using scientific notation, store as Integer, expose Int)
    
   Numbers are polymorphic under the surface, and the compiler doesn't assign them a concrete type until it is forced to.
